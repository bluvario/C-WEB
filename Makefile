...
LIB_SRC := src/core/cweb.c src/utils/strbuf.c src/utils/xmem.c src/utils/file.c src/utils/sv.c src/utils/log.c src/utils/strmap.c src/utils/url.c src/utils/base64.c src/utils/buffer.c src/utils/thread.c src/utils/thread_pool.c src/utils/json.c src/security/escape.c src/security/path.c src/security/headers.c src/http/http.c src/http/net.c src/http/request.c src/http/response.c src/http/server.c src/http/date.c src/http/params.c src/http/mime.c src/http/static.c src/http/negotiate.c src/http/cookie.c src/http/multipart.c src/http/auth.c src/http/sse.c src/routing/route.c src/routing/router.c
